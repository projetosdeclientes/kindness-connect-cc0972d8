...
const categories: Category[] = [
  {
    ...
    logos: [
      ...
      { name: "SBT", file: "sbt.png", review: "restaurada em vetor 4K para corrigir proporção/qualidade do arquivo anterior" },
      { name: "Band", file: "band.png" },
      { name: "TV Cultura", file: "tv-cultura.png", review: "restaurada em vetor 4K por falta de fonte oficial pública em alta resolução exatamente igual ao gabarito" },
  ...
  },
  {
    ...
    logos: [
      ...
      { name: "Band Sports", file: "bandsports.png", review: "restaurada em vetor 4K porque o asset anterior estava ilegível no card" },
  ...
  },
  {
    ...
    logos: [
      ...
      { name: "Universal Music Group", file: "universal-music.png" },
