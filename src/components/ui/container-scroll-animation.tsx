...
const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-6xl -mt-12 mx-auto h-[22rem] sm:h-[28rem] md:h-[38rem] w-full border-2 md:border-4 border-border/60 p-2 md:p-4 bg-card rounded-[24px] md:rounded-[30px] shadow-2xl"
    >
      <div className="h-full w-full overflow-hidden rounded-xl md:rounded-2xl bg-background">
        {children}
      </div>
    </motion.div>
  );
